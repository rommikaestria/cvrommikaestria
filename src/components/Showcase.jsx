    ...
    <section id="books" className="py-20 bg-light dark:bg-dark transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 md:mt-24 mb-8 md:mb-16 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Berbagi wawasan seputar teknologi, tutorial ajjjajajafdsfds, dan edukasi melalui kanal YouTube <a href="https://www.youtube.com/@dataroom40" target="_blank" rel="noreferrer" className="text-red-600 font-bold hover:underline">@dataroom40</a>
          </p>
        </div>
